...
def random_walk(turtles):
    ...
    for turtle in turtles:
        ...
        if turtle.xcor() > 250:
            color = translate(colors[i])
            messagebox.showinfo("showinfo", "Rùa màu {} chiến thắng!!!".format(color))  # The alert.
            run = False
        i += 1
...
run = True
if (messagebox.askquestion("showinfo", "Bắt đầu đua?")) == 'yes':
    ...
    print(" Rùa chiến thắng chạy mất:{0}".format(elapsed_time) + "[sec]")
screen.exitonclick()
